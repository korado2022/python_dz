...
class Cell:
    ...
    def __add__(self, other):
        return f'Число ячеек общей клетки после сложения = {self.nums + other.nums}'

    def __sub__(self, other):
        if self.nums - other.nums > 0:
            return f'Число ячеек общей клетки после вычитания = {self.nums - other.nums}'
        else:
            return 'Ячеек в первой клетке меньше чем во второй, вычитание невозможно'

    def __mul__(self, other):
        return f'Число ячеек общей клетки после умножения = {self.nums * other.nums}'

    def __truediv__(self, other):
        return f'Число ячеек общей клетки после деления = {round(self.nums / other.nums)}'
